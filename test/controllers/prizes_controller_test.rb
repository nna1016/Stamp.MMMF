...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post prizes_url, params: { prize: { prize: @prize.prize, student_no: @prize.student_no } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { prize: @prize.prize, student_no: @prize.student_no } }
