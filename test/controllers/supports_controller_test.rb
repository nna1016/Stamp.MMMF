...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { answer: @support.answer, kind: @support.kind, order: @support.order, question: @support.question } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { answer: @support.answer, kind: @support.kind, order: @support.order, question: @support.question } }
